...
(function($) {
  ...
  $.fn.tweet = function(o){
    ...
    return this.each(function(){
      ...
      var intro = '<p class="intro">'+s.intro_text+'</p>';
      var outro = '<p class="outro">'+s.outro_text+'</p>';
      ...
      $.getJSON(build_url(), function(data) {
        ...
        $.each((data.results || data), function(i,item){
          ...
          var join_template = '<span class="join"> '+join_text+' </span>';
          ...
          var text = '<span class="text">' +$([item.text]).linkUrl().linkUser().linkHash().makeHeart().capAwesome().capEpic()[0]+ '</span>';
